...
MSB2, save v5, and rollback/effect contracts. See [Formal 1.0](./formal-1-0).
...
| Save | Writers emit **v5**; readers accept v2-v5; v5 persists stable identity and dissolve continuation |
